...
![New RoomOS API found](data/images/New%20RoomOS%20API%20found.png)
...
![No new RoomOS API's found](data/images/No%20new%20RoomOS%20API's%20found.png)
...
![No RoomOS versions found](data/images/No%20RoomOS%20versions%20found.png)
- This means no API documentation was found on the page at all.
- Selecting the **OK** button will terminate the program.

#### If webpage is unreachable:
![Error 404 Not Found](data/images/Error%20404%20Not%20Found.png)
